...
class SemaphoreSmsExtensionTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @covers Yan/Bundle/SemaphoreSmsBundle/DependencyInjection/SemaphoreSmsExtension::load
     */
    public function testSmsDeliveryAddressValues()
    {
        $configs = array(
            $this->root => array(
                'api_key' => 'ThisIsATestApiKey',
                'sms_delivery_address' => '09173149060'
            )
        );

        $this->sut->load($configs, $this->container);

        $this->assertTrue($this->container->hasParameter($this->root.".sms_delivery_address"));
        $this->assertEquals($configs[$this->root]['sms_delivery_address'], $this->container->getParameter($this->root.".sms_delivery_address"));
    }

    /**
     * @covers Yan/Bundle/SemaphoreSmsBundle/DependencyInjection/SemaphoreSmsExtension::load
     */
    public function testSmsDeliveryAddressDefaultValue()
    {
        $configs = array(
            $this->root => array(
                'api_key' => 'ThisIsATestApiKey'
        ...
        $this->assertTrue($this->container->hasParameter($this->root.".sms_delivery_address"));
        $this->assertTrue(is_null($this->container->getParameter($this->root.".sms_delivery_address")));
    }

    /**
     * @covers Yan/Bundle/SemaphoreSmsBundle/DependencyInjection/SemaphoreSmsExtension::load
     */
    public function testLimitMessagesValues()
    {
        $configs = array(
            $this->root => array(
                'api_key' => 'ThisIsATestApiKey',
        ...
        $this->assertTrue($this->container->hasParameter($this->root.".limit_messages"));
        $this->assertEquals($configs[$this->root]['limit_messages'], $this->container->getParameter($this->root.".limit_messages"));
    }

    /**
     * @covers Yan/Bundle/SemaphoreSmsBundle/DependencyInjection/SemaphoreSmsExtension::load
     */
    public function testLimitMessagesDefaultValue()
    {
        $configs = array(
            $this->root => array(
                'api_key' => 'ThisIsATestApiKey'
        ...
        $this->assertTrue($this->container->hasParameter($this->root.".limit_messages"));
        $this->assertTrue($this->container->getParameter($this->root.".limit_messages"));
    }

    /**
     * @covers Yan/Bundle/SemaphoreSmsBundle/DependencyInjection/SemaphoreSmsExtension::load
     */
    public function testLimitMessagesSetValue()
    {
        $configs = array(
            $this->root => array(
                'api_key' => 'ThisIsATestApiKey',
