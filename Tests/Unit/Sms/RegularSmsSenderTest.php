...
use Yan\Bundle\SemaphoreSmsBundle\Sms\RegularSmsSender;
...
/**
 * Unit test for RegularSmsSender
 *
 * @author  Yan Barreta
 * @version dated: April 30, 2015 3:55:29 PM
 */
class RegularSmsSenderTest extends \PHPUnit_Framework_TestCase
{
    private $sut;
    private $root;
    ...
    /**
     * @covers Yan/Bundle/SemaphoreSmsBundle/Sms/RegularSmsSender::composeParameters
    ...
    public function testGetComposeParameters($fromValue, $formatNumberValue, $messageValue, $senderNameValue, $apiKeyValue, $expectedValue)
    {
        ...
        $sut = new RegularSmsSender($configurationMock, $curlMock, $messageComposerMock);
    ...
    /**
     * @covers Yan/Bundle/SemaphoreSmsBundle/Sms/RegularSmsSender::initUrl
     */
    public function testInitUrl()
    {
        ...
        $this->assertEquals('http://api.semaphore.co/api/v4/messages', $sut->initUrl());
